 ...
 * Original stub: https://github.com/JetBrains/phpstorm-stubs/blob/master/zstd/zstd.php
 */
...
namespace {
	 ...
	 * @return string|false Returns the compressed data or FALSE if an error occurred.
	 */
	function zstd_compress_usingcdict(string $data, string $dict){}
	 ...
	 * @return string|false Returns the decompressed data or FALSE if an error occurred.
	 */
	function zstd_decompress_dict(string $data, string $dict){}
	 ...
	 * @return string|false Returns the decompressed data or FALSE if an error occurred.
	 */
	function zstd_uncompress_usingcdict(string $data, string $dict){}
	 ...
	 * @return string|false Returns the decompressed data or FALSE if an error occurred.
	 */
	function zstd_decompress_usingcdict(string $data, string $dict){}
}
...
namespace Zstd{
	 ...
	 * @return string|false Returns the compressed data or FALSE if an error occurred.
	 */
	function compress(string $data, int $level = 3){}
	 ...
	 * @return string|false Returns the decompressed data or FALSE if an error occurred.
	 */
	function uncompress(string $data){}
	 ...
	 * @return string|false Returns the compressed data or FALSE if an error occurred.
	 */
	function compress_dict(string $data, string $dict){}
	 ...
	 * @return string|false Returns the decompressed data or FALSE if an error occurred.
	 */
	function uncompress_dict(string $data, string $dict){}
}